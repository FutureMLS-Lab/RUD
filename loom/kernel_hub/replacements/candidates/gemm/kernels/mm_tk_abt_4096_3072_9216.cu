// mm_abt_4096x3072x9216.cu — Shape-specific TK ABt GEMM for 4096x3072x9216
//
// Uses ThunderKittens framework with tuned parameters for this shape:
//   M_BLOCK=2 (128M), N_BLOCK=3 (192N), SUPER_M=8
//   Wider effective N tile (192 vs generic 256) gives 512 tiles vs 384,
//   better SM occupancy across waves, and better L2 fit for B data.
//
// Grid: persistent 132 blocks, 4-stage pipeline, ~4 tiles per SM.
...
// Reuse the generic matmul layout/template but with shape-tuned params
...
template<int _M_BLOCK=2, int _N_BLOCK=3, int _SUPER_M=8>
struct matmul_4096_3072_9216 {
...
using mmt = matmul_4096_3072_9216<2, 4, 4>;

using global_layout = typename mmt::layout::global_layout;
using globals = typename mmt::layout::globals;

extern "C" int gemm_4096x3072x9216_globals_size() {
    return (int)sizeof(globals);
}

extern "C" void gemm_4096x3072x9216_make_globals(
    void* out_buf,
...
extern "C" void gemm_4096x3072x9216_grid_dims(int M, int N, int K, int* x, int* y, int* z) {
    *x = mmt::grid(0, 0, 0).x;
    *y = 1;
    *z = 1;
}

extern "C" int gemm_4096x3072x9216_block_dim() {
    return (int)kittens::prototype::detail::NUM_THREADS_v<mmt>;
}

extern "C" int gemm_4096x3072x9216_shmem_bytes() {
    return MAX_SHARED_MEMORY - 1024;
}

extern "C" int gemm_4096x3072x9216_num_tma_descriptors() { return 3; }

extern "C" void gemm_4096x3072x9216_describe_tma_descriptors(
    void* d_A, void* d_Bt, void* d_C,
    int M, int N, int K,
    void* out_meta
) {
