"""Persisted multi-project registry for `claudeloop web`."""
...
DEFAULT_REGISTRY_PATH = Path.home() / ".claudeloop" / "web-projects.json"
...
class WebProjectRegistry:
    ...
    def prune_redundant_parent_projects(self, launch_root: Path) -> None:
        ...
        Intended for **multi-project workspace** mode (``claudeloop web --projects``): the launch directory
